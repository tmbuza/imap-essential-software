...
[R](https://www.r-project.org/) is open-source software designed for statistical computing, data analysis, and graphics[3]. You can install the R application on your personal computer to work with the R programming language. Follow these steps below to download and install R:
