...
We have categorized quality control (QC) tools under bioinformatics tools. Most of these QC tools are available via the bioconda channel. Below are some common bioinformatics tools used to understand read features and their quality scores. You can click on the hyperlinks to learn more about installing the software:
